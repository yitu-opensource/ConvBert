...
"""Config controlling hyperparameters for fine-tuning."""
...
class FinetuningConfig(object):
  ...
  def __init__(self, model_name, data_dir, **kwargs):
    ...
    self.task_names = ["cola"]  # which tasks to learn
    ...
    self.init_checkpoint = None if self.debug else tf.train.latest_checkpoint(pretrained_model_dir)
